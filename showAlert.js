...
function showConfirm(t,m,fn){
    ...
    var alertstr='<div class="ymodalAlert">'+
        ...
        '<div class="ymodalonfirm"><div class="alertbtn alertbtnSure">Confirm</div></div>'+
        '</div>'+
        '</div>';

        //alert($("body").append(alertstr));
...
function confirmCancel(t,m,surefn,canclefn){
    includeLinkStyle();
    var confirmstr='<div class="ymodalAlert">'+
        '<div class="ymodalAlertBody">'+
        '<div class="ymodalTitle">'+t+'</div>'+
        '<div class="ymodalMsg">'+m+'</div>'+
        '<div class="ymodalonfirm"><div class="confrimbtn confrimbtnCancle">Cancel</div><div class="confrimbtn confrimbtnSure">Confirm</div></div>'+
        '</div>'+
        '</div>';
